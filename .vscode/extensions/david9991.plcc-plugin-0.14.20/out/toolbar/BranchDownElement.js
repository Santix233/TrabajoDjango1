...
exports.BranchDownElement = void 0;
const toolbarElement_1 = require("./toolbarElement");
class BranchDownElement extends toolbarElement_1.toolbarElement {
    constructor() {
        super();
        this.toolbarElement = `
        <li type="branchdown">            
...
exports.BranchDownElement = BranchDownElement;
//# sourceMappingURL=BranchDownElement.js.map