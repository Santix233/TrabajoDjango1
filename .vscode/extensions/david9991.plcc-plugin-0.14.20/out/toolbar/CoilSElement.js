...
exports.CoilSElement = void 0;
const toolbarElement_1 = require("./toolbarElement");
class CoilSElement extends toolbarElement_1.toolbarElement {
    constructor() {
        super();
        this.toolbarElement = `
        <li type="coils">
...
exports.CoilSElement = CoilSElement;
//# sourceMappingURL=CoilSElement.js.map